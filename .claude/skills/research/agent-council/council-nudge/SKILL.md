---
name: council-nudge
description: Nudge a specific agent to reconsider its opinion based on a corrected assumption. Sends the original question + response + correction to one agent and saves the updated opinion alongside the original for comparison.
allowed-tools:
  - Bash
---
