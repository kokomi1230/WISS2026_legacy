---
name: awesome-design
description: Curated reference collection of design-system markdown docs (VoltAgent awesome-design-md). Use when designing UI, picking color palettes, or aligning with established brands' design language.
---
