...
description: Record the outcome of a past Agent Council decision. Was the council right? Builds calibration data over time to learn which models are best at what.
allowed-tools:
  - Bash
---
